# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/37.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/37.c" 2
...
void main(int n) {
 ...
 m = x;
  ...
  if(n>0)
    ((void) ((0<=m && m<n) ? 0 : (__assert_fail ("0<=m && m<n", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/37.c", 19, __PRETTY_FUNCTION__), 0)));
}
