# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/41.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/41.c" 2
...
void main(int n, int flag) {
 ...
 if(!(k>=0))
   ...
   int z = k + i + j;
   ((void) ((z > 2*n) ? 0 : (__assert_fail ("z > 2*n", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/41.c", 23, __PRETTY_FUNCTION__), 0)));
}
