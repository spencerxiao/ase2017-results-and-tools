# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/42.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/42.c" 2
...
void main(int flag)
{
  ...
  if(flag)
    a++;
  ((void) ((a%2==1) ? 0 : (__assert_fail ("a%2==1", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/42.c", 35, __PRETTY_FUNCTION__), 0)));
}
