# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/38.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/38.c" 2
...
void main(int n)
{
  ...
  if(i%2 == 0)
    ((void) ((x==2*y) ? 0 : (__assert_fail ("x==2*y", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/38.c", 16, __PRETTY_FUNCTION__), 0)));
}
