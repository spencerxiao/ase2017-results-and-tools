# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/44.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/44.c" 2
...
void main(int k, int flag)
{
  ...
  if(flag == 1)
    ((void) ((j == i) ? 0 : (__assert_fail ("j == i", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/44.c", 28, __PRETTY_FUNCTION__), 0)));
