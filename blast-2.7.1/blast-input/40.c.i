# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/40.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/40.c" 2
...
void main( int flag)
{
  ...
  int __BLAST_NONDET;
   ...
   if(flag)
     ((void) ((a==b) ? 0 : (__assert_fail ("a==b", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/40.c", 28, __PRETTY_FUNCTION__), 0)));
}
