# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/13.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/13.c" 2
...
void main(int flag) {
   ...
   if(k!=0)
     ((void) ((j==2*k+2) ? 0 : (__assert_fail ("j==2*k+2", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/13.c", 20, __PRETTY_FUNCTION__), 0)));
}
