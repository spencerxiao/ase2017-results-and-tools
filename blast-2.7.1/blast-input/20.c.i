# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/20.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/20.c" 2
...
void main(int x, int y, int k, int j, int i, int n)
{
    ...
    ((void) (((x+y)== k) ? 0 : (__assert_fail ("(x+y)== k", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/20.c", 24, __PRETTY_FUNCTION__), 0)));
    if(n>0)
    {
    ((void) ((0<=m) ? 0 : (__assert_fail ("0<=m", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/20.c", 27, __PRETTY_FUNCTION__), 0)));
   ((void) ((m<n) ? 0 : (__assert_fail ("m<n", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/20.c", 28, __PRETTY_FUNCTION__), 0)));
    }
