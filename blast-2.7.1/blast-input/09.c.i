# 1 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/09.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/09.c" 2
...
void main(){
 ...
 int __BLAST_NONDET;
  ...
  n = i;
  while (1) {
    ((void) ((k >= 0) ? 0 : (__assert_fail ("k >= 0", "/home/spencerxiao/Experiments/tacas17/blast-2.7.1/oopsla13-benchmarks-blast/09.c", 34, __PRETTY_FUNCTION__), 0)));
    k = k -1;
    i = i - 1;
    j = j + 1;
    if (j < n) {
