...
r(p(pc(main-4-0), data(V2, V4, V3, V1)), p(pc(main-1-11), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = 0, V3p = V3, V1p = V1], 4). % y := 0
stmtsrc(4, 'y=0;').
transition_access( 4, [_, w, _, _] ).
r(p(pc(main-1-11), data(V2, V4, V3, V1)), p(pc(main-7-11), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 5). % 
stmtsrc(5, 'skip;').
transition_access( 5, [_, _, _, _] ).
r(p(pc(main-7-11), data(V2, V4, V3, V1)), p(pc(main-8-13), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 6). % 
stmtsrc(6, 'skip;').
transition_access( 6, [_, _, _, _] ).
r(p(pc(main-7-11), data(V2, V4, V3, V1)), p(pc(main-9-11), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 7). % 
stmtsrc(7, 'skip;').
transition_access( 7, [_, _, _, _] ).
r(p(pc(main-8-13), data(V2, V4, V3, V1)), p(pc(main-12-13), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 8). % 
stmtsrc(8, 'skip;').
transition_access( 8, [_, _, _, _] ).
r(p(pc(main-12-13), data(V2, V4, V3, V1)), p(pc(main-13-14), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 9). % 
stmtsrc(9, 'skip;').
transition_access( 9, [_, _, _, _] ).
r(p(pc(main-12-13), data(V2, V4, V3, V1)), p(pc(main-14-13), data(V2p, V4p, V3p, V1p)), [], [V2p = V2, V4p = V4, V3p = V3, V1p = V1], 10). % 
stmtsrc(10, 'skip;').
