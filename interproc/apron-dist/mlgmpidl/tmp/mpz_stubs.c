...
{
  mpz_ptr OUTOUTOUT; /*out*/
  value _vres;

  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  mpz_init(OUTOUTOUT);
  _vres = camlidl_c2ml_mpz_mpz_ptr(&OUTOUTOUT, _ctx);
  camlidl_free(_ctx);
  return _vres;
}
	...
	value _v_ROP2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_ROP1, &ROP1, _ctx);
  camlidl_ml2c_mpz_mpz_ptrm(_v_ROP2, &ROP2, _ctx);
  mpz_swap(ROP1, ROP2);
  camlidl_free(_ctx);
  return Val_unit;
}
	...
	value _v_D)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_Q, &Q, _ctx);
	...
	value _v_D)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_R, &R, _ctx);
  camlidl_ml2c_mpz_mpz_ptr(_v_N, &N, _ctx);
  camlidl_ml2c_mpz_mpz_ptr(_v_D, &D, _ctx);
  mpz_cdiv_r(R, N, D);
  camlidl_free(_ctx);
	...
	value _v_OP2)
{
  ...
  if (_v_ROP == Val_int(0)) {
    ...
    _v1 = Field(_v_ROP, 0);
    ROP = &_c2;
    camlidl_ml2c_mpz_mpz_ptrm(_v1, &_c2, _ctx);
  }
  camlidl_ml2c_mpz_mpz_ptr(_v_OP1, &OP1, _ctx);
  OP2 = Long_val(_v_OP2);
  /* begin user-supplied calling sequence */
	...
	value _v_B)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_G, &G, _ctx);
  camlidl_ml2c_mpz_mpz_ptrm(_v_S, &S, _ctx);
  camlidl_ml2c_mpz_mpz_ptrm(_v_T, &T, _ctx);
	...
	value _v_N)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_FN, &FN, _ctx);
  N = Long_val(_v_N);
  mpz_fib_ui(FN, N);
  camlidl_free(_ctx);
  return Val_unit;
	...
	value _v_N)
{
  ...
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_FN, &FN, _ctx);
  camlidl_ml2c_mpz_mpz_ptrm(_v_FNSUB1, &FNSUB1, _ctx);
  N = Long_val(_v_N);
	...
	value _v_N)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_LN, &LN, _ctx);
  N = Long_val(_v_N);
  mpz_lucnum_ui(LN, N);
  camlidl_free(_ctx);
  return Val_unit;
	...
	value _v_N)
{
  ...
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_LN, &LN, _ctx);
  camlidl_ml2c_mpz_mpz_ptrm(_v_LNSUB1, &LNSUB1, _ctx);
  N = Long_val(_v_N);
