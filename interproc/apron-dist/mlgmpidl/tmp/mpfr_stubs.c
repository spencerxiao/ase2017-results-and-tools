...
extern void camlidl_mpq_ptr_ml2c(value, mpq_ptrm *);
#define camlidl_ml2c_mpq_mpq_ptrm(v,c,ctx) camlidl_mpq_ptr_ml2c(v,c)

extern value camlidl_mpq_ptr_c2ml(mpq_ptrm *);
...
extern void camlidl_mpf_ptr_ml2c(value, mpf_ptrm *);
#define camlidl_ml2c_mpf_mpf_ptrm(v,c,ctx) camlidl_mpf_ptr_ml2c(v,c)

extern value camlidl_mpf_ptr_c2ml(mpf_ptrm *);
#define camlidl_c2ml_mpf_mpf_ptrm(c,ctx) camlidl_mpf_ptr_c2ml(c)
...
#define camlidl_ml2c_mpfr_mpfr_ptrm(v,c,ctx) camlidl_mpfr_ptr_ml2c(v,c)

#define camlidl_c2ml_mpfr_mpfr_ptrm(c,ctx) camlidl_mpfr_ptr_c2ml(c)

extern void camlidl_ml2c_mpfr_struct_mpfr_rnd_t(value, struct mpfr_rnd_t *, camlidl_ctx _ctx);
extern value camlidl_c2ml_mpfr_struct_mpfr_rnd_t(struct mpfr_rnd_t *, camlidl_ctx _ctx);
	...
	value _v_PREC)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_X, &X, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
...
{
  mpfr_ptr OUTOUTOUT; /*out*/
  value _vres;

  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  mpfr_init(OUTOUTOUT);
  _vres = camlidl_c2ml_mpfr_mpfr_ptr(&OUTOUTOUT, _ctx);
  camlidl_free(_ctx);
  return _vres;
}
	...
	value _v_PREC)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_ROP, &ROP, _ctx);
  PREC = Long_val(_v_PREC);
...
value camlidl_mpfr_mpfr__strtofr(
	value _v_ROP,
	value _v_STR,
	value _v_BASE,
	value _v_RND)
	...
	value _v_ROP2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_ROP1, &ROP1, _ctx);
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_ROP2, &ROP2, _ctx);
  mpfr_swap(ROP1, ROP2);
  camlidl_free(_ctx);
  return Val_unit;
}
	...
	value _v_RND)
{
  ...
  Begin_roots_block(_vres, 2)
    _vres[0] = Val_int(_res);
    _vres[1] = camlidl_c2ml_mpfr_mpfr_ptr(&OUTOUTOUT, _ctx);
    _vresult = camlidl_alloc_small(2, 0);
    Field(_vresult, 0) = _vres[0];
    Field(_vresult, 1) = _vres[1];
  End_roots()
	...
	value _v_OP)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpz_mpz_ptrm(_v_Z, &Z, _ctx);
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
	...
	value _v_RND)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_Y, &Y, _ctx);
  camlidl_ml2c_mpfr_mpfr_ptr(_v_X, &X, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
	...
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_j0(ROP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_j1(
	value _v_ROP,
	value _v_OP,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_j1(ROP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_jn(
	value _v_ROP,
	value _v_n,
	value _v_OP,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_jn(ROP, n, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_y0(
	value _v_ROP,
	value _v_OP,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_y0(ROP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_y1(
	value _v_ROP,
	value _v_OP,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_y1(ROP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_yn(
	value _v_ROP,
	value _v_n,
	value _v_OP,
	value _v_RND)
	...
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OPZ, &OPZ, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_fms(ROP, OPX, OPY, OPZ, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}
	...
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_frac(ROP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_modf(
	value _v_IOP,
	value _v_FOP,
	value _v_OP,
	value _v_RND)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_IOP, &IOP, _ctx);
  camlidl_ml2c_mpfr_mpfr_ptrm(_v_FOP, &FOP, _ctx);
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP, &OP, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_modf(IOP, FOP, OP, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_fmod(
	value _v_ROP,
	value _v_OP1,
	value _v_OP2,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP2, &OP2, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_fmod(ROP, OP1, OP2, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_mpfr_mpfr_remainder(
	value _v_ROP,
	value _v_OP1,
	value _v_OP2,
	value _v_RND)
{
  ...
  camlidl_ml2c_mpfr_mpfr_ptr(_v_OP2, &OP2, _ctx);
  camlidl_ml2c_mpfr_mpfr_rnd_t(_v_RND, &RND, _ctx);
  _res = mpfr_remainder(ROP, OP1, OP2, RND);
  _vres = Val_int(_res);
  camlidl_free(_ctx);
  return _vres;
}
