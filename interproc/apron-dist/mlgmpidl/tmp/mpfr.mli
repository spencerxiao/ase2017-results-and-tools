...
val set_str : t -> string -> base:int -> mpfr_rnd_t -> unit
external mpfr__strtofr : mpfr_ptrm -> string -> int -> mpfr_rnd_t -> int * int
	= "camlidl_mpfr_mpfr__strtofr"

val strtofr : t -> string -> base:int -> mpfr_rnd_t -> int * int
...
val init_set_str : string -> base:int -> mpfr_rnd_t -> 'a tt
...
val get_str : base:int -> digits:int -> t -> mpfr_rnd_t -> string * int
...
val div_2exp : t -> t -> int -> mpfr_rnd_t -> int
