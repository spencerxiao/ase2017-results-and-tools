...
extern void camlidl_mpfr_ptr_ml2c(value, mpfr_ptrm *);
#define camlidl_ml2c_mpfr_mpfr_ptrm(v,c,ctx) camlidl_mpfr_ptr_ml2c(v,c)

extern value camlidl_mpfr_ptr_c2ml(mpfr_ptrm *);
...
{
  gmp_randstate_ptr OUTOUTOUT; /*out*/
  value _vres;

  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  gmp_randinit_default(OUTOUTOUT);
  _vres = camlidl_c2ml_gmp_random_gmp_randstate_ptr(&OUTOUTOUT, _ctx);
  camlidl_free(_ctx);
  return _vres;
}
	...
	value _v_N)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_mpf_mpf_ptrm(_v_ROP, &ROP, _ctx);
  camlidl_ml2c_gmp_random_gmp_randstate_ptr(_v_STATE, &STATE, _ctx);
  N = Long_val(_v_N);
...
value camlidl_gmp_random_mpfr_urandom(
	value _v_ROP,
	value _v_STATE,
	value _v_rnd)
{
