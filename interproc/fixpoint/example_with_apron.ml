(* Loris Dal Lago. This file can be released under LGPL license. *)

(** Example of use of Fixpoint library together with APRON library
    http://apron.cri.ensmp.fr/library/
*)

(** Compile this with the following command:

    ocamlfind ocamlc -annot -g -cc "g++"  -o example_with_apron.byte example_with_apron.mli example_with_apron.ml -package fixpoint,apron,apron.octD,apron.boxMPQ,apron.polkaMPQ,apron.ppl -linkpkg
*)
